...
namespace InvokersLib
{
    public class INVOKERS
    {
        ...
        public static void InvokeProgressValue(ProgressBar control, int value)
        {
            try
            {
                if (control.InvokeRequired)
        ...
        public static void InvokeProgressMaximum(ProgressBar control, int value)
        {
            try
            {
                if (control.InvokeRequired)
        ...
        public static void InvokeProgressMaximum(ProgressBar control)
        {
            try
            {
                if (control.InvokeRequired)
